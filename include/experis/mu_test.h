#ifndef MU_63C7FC23C29240AC95892AD720A1AF49
#define MU_63C7FC23C29240AC95892AD720A1AF49
#
/**
 * mu_test.h
...
fine static MT_SYMBOL mt__current_test_name;clock_t mt__total_time;int mt__trace_on,mt__current_test_was_traced;struct mt__AssertResult{int youShalN0tPass;int where;MT_SYMBOL message;MT_SYMBOL actual_expected;};type\
...
mt__fprintInBox(stdout, __test_name, 37);init_signals();MT_TRAXER;while(mt__pUtRec->whatMayFail){ \
    clock_t __time_spent;volatile clock_t __begin,__end;struct mt__AssertResult __r;int sgu1;\
...
#define BEGIN_UNIT(name)    UNIT_IMPL(name)
#define BEGIN_TEST(name)    UNIT_IMPL(name)
#define END_UNIT            END_UNIT_IMPL
#define END_TEST            END_UNIT_IMPL
#define TEST_SUITE(name)    TEST_SUITE_IMPL(name)
#define BEGIN_SUITE(name)   TEST_SUITE_IMPL(name)
...
#define ASSERT_FAIL(msg)                            ASSERT_THAT(0 && msg)
